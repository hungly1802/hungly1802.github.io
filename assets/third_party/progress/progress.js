$(function () {
    if (![null, undefined].includes($('#counter')) && $('#counter').length > 0) {
...
$(function () {
    if (![null, undefined].includes($('#counter1')) && $('#counter1').length > 0) {
...
$(function () {
    if (![null, undefined].includes($('#counter2')) && $('#counter2').length > 0) {
